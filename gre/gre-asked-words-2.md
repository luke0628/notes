...
## infraction / affliction 区分笔记

**对比：**
infraction（违规/违法）vs affliction（痛苦/折磨）
- infraction: legal/rule context — breaking small rules
- affliction: suffering/pain context — prolonged suffering
- 区别本质: infraction 是行为层面的冒犯，affliction 是体验层面的痛苦

---

## effulgent

**释义：** 光芒四射的、光辉灿烂的（形容极亮的光或光芒四射的状态）

**词根：** 拉丁语 ex-（向外）+ fulgere（闪耀）→ "向外闪耀"。同根词：fulgent（闪耀的）、refulgent（辉煌的）。

**场景：**
- **文学/人物刻画（GRE阅读）** — 描写人物光彩照人的精神面貌，如 "effulgent smile" 形容灿烂至极的笑容，常用于传记或人物赞美中
- **填空逻辑/程度对应** — 与 dim、obscure、shadowy 形成强烈反义关系。effulgent = 极度亮，中等亮词如 bright/luminous 不足以匹配 effulgent 的极端程度
- **宗教/神话论述** — 描述神性光芒、启示之光（divine effulgence），出现在涉及宗教主题的历史文章或比较文化类阅读中

**画面：** 黎明时分，太阳从海平面跃出的一刹那，万丈金光刺破云层铺满整片海面，不是明亮，是刺痛眼睛的 effulgence。

**Synonyms:** radiant, brilliant, resplendent, luminous, refulgent
**Antonyms:** dim, dull, lackluster, tenebrous, murky
